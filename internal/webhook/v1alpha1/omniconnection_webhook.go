...
// +kubebuilder:webhook:path=/validate-omni-texas-hpc-org-v1alpha1-omniconnection,mutating=false,failurePolicy=fail,sideEffects=None,groups=omni.texas-hpc.org,resources=omniconnections,verbs=create;update,versions=v1alpha1,name=vomniconnection-v1alpha1.kb.io,admissionReviewVersions=v1
